...
- **A clear mental model** — content, tags, and properties. Tags group your notes; properties slice them into the exact views you want; hubs are just saved queries on top. You never wonder where something goes.
...
| [02-mental-model.md](02-mental-model.md) | The content + tags + properties model and why it works |
